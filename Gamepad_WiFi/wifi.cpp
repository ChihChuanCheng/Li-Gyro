...
void ssid_pswd_write(String input_ssid, String input_pswd) {
  ...
  {
    EEPROM.write(10+i, input_pswd[i]);
#ifdef __LOG__
    Serial.print(char(EEPROM.read(10+i)));
#endif
  }
#ifdef __LOG__
  Serial.println();
...
void init_wifi()
{
  /* ready to use the first 30 elements */
  EEPROM.begin(30);
